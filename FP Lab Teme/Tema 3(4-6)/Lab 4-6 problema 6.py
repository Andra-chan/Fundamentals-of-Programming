    ...
    try:
        ...
        for i in range(0, len(lista_destinatie)):
            if stergere1_destinatie == lista_destinatie[i]:
                del lista_data_inceput_zi[i]
                del lista_data_inceput_luna[i]
                del lista_data_inceput_an[i]
                del lista_data_sfarsit_zi[i]
                del lista_data_sfarsit_luna[i]
                del lista_data_sfarsit_an[i]
                del lista_destinatie[i]
                del lista_pret[i]
                print("Stergerea a fost realizata cu succes!")
                print("""\nPachetele actualizate sunt: """
                      "\n1. Ziua de inceput: ", lista_data_inceput_zi,
                      "\n2. Luna de inceput: ", lista_data_inceput_luna,
                      "\n3. Anul de inceput: ", lista_data_inceput_an,
                      "\n4. Ziua de sfarsit: ", lista_data_sfarsit_zi,
                      "\n5. Luna de sfarsit: ", lista_data_sfarsit_luna,
                      "\n6. Anul de sfarsit: ", lista_data_sfarsit_an,
                      "\n7. Destinatia: ", lista_destinatie,
                      "\n8. Pretul: ", lista_pret)
                break
    except ValueError:
    ...
    try:
        ...
        for i in range(0, len(lista_data_sfarsit_zi)):
            if tiparire_zi_sfarsit >= lista_data_sfarsit_zi[i] and tiparire_luna_sfarsit >= lista_data_sfarsit_luna[i] and tiparire_an_sfarsit >= lista_data_sfarsit_an[i] and tiparire_zi_inceput <= lista_data_inceput_zi[i] and tiparire_luna_inceput <= lista_data_inceput_luna[i] and tiparire_an_inceput <= lista_data_inceput_an[i]:
                print("""\nPachet in intervalul dat: """
                      "\n1. Ziua de inceput: ", lista_data_inceput_zi[i],
                      "\n2. Luna de inceput: ", lista_data_inceput_luna[i],
                      "\n3. Anul de inceput: ", lista_data_inceput_an[i],
                      "\n4. Ziua de sfarsit: ", lista_data_sfarsit_zi[i],
                      "\n5. Luna de sfarsit: ", lista_data_sfarsit_luna[i],
                      "\n6. Anul de sfarsit: ", lista_data_sfarsit_an[i],
                      "\n7. Destinatia: ", lista_destinatie[i],
                      "\n8. Pretul(ron): ", lista_pret[i])               
    except ValueError:
        print("\nNu ati introdus un numar! Revenire la meniul principal...")
        meniu1()
        meniu_aplicatii()
